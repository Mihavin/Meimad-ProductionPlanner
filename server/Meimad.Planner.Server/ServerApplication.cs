...
using Meimad.Planner.Server.Api.ResourcePlanning;
...
public static class ServerApplication
{
        ...
        Action<IWebHostBuilder>? configureWebHost = null)
    {
        ...
        builder.Services.AddSingleton<IProductionRunDebugTimelineRepository, SqliteProductionRunDebugTimelineRepository>();
        builder.Services.AddSingleton<ProductionRunDebugTimelineService>();
        builder.Services.AddSingleton<IOperationalAnomalyRepository, SqliteOperationalAnomalyRepository>();
        ...
        builder.Services.AddSingleton<ITabletEventRepository, SqliteTabletEventRepository>();
        builder.Services.AddSingleton<TabletEventService>();
