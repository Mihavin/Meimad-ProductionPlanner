...
The historical filename is retained for existing links. External HFO/vendor
approval is not a prerequisite. Approval in this document means a written review
...
- [ ] The written internal engineering decision record is completed in
  [the engineering review worksheet](haas-hfo-review-request-2026-08-27.md).
...
- [ ] One event-sequence contract is approved for OLC, SVS, SVF, cycle start, and
  cycle end. It explicitly defines reboot and exhaustion/wrap behavior.
