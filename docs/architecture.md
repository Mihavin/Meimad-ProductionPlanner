...
- **Status:** Target architecture; Server foundation through schema v52, Production Runs and operational workflow-event projection, staged legacy import, Timeline, TV Dashboard, E-Ink API/simulator, Single Edit Mode, verified backup, Windows operational workspaces, and Case Operation graph validation implemented
