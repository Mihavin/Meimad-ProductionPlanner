...
- Implemented ordered Server schema migrations through v30. Kitaron v28 stores encrypted connection/test configuration, v29 stores the reviewed mapping and detected columns, and v30 stores one-way synchronization state plus ownership-aware source links. Earlier migration contracts remain unchanged.
