...
tablet-offline threshold is approved. Revocation, expiry, verification failure,
...
recovery with no bypass. Replacement-tablet assignment/credential rotation remain
